...
public class Pixel {
    ...
    public String toString() {
        String answer = ("(" + red + ", " + green + ", " + blue + ")");
        return answer;
    }

    public boolean inRange(Pixel other, int range) {
        if((Math.abs(this.red - other.red)) <= range
            && (Math.abs(this.green - other.green)) <= range
            && (Math.abs(this.blue - other.blue)) <= range) {
            return true;
        }
        return false;
    }
